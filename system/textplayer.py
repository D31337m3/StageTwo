...
class ScriptDisplayer:
    ...
    def typewriter_effect(self, text, line_idx, color=0xFFFFFF):
        ...
        self.cursor_label = label.Label(self.font, text="_", color=0x00FF00, x=self.margin, y=self.margin + line_idx*self.line_spacing)
...
def main():
    ...
    script_displayer = ScriptDisplayer(
        display=display,
